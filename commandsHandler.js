    ...
    client.on('messageCreate', async message => {
        ...
        if (fullCommand === config.cmdDone) {
            ...
            try {
                ...
                const ratingEmbed = new EmbedBuilder()
                    ...
                    .setDescription(`لقد أتممت معاملتك في سيرفر **${message.guild.name}**.\nيرجى تقييم الوسيط <@${message.author.id}> من خلال الأزرار:`)
                    .setColor('#3ba55d');
        ...
        if (fullCommand === config.cmdBan) {
            ...
            await userToBan.ban({ reason: `${reason} - By: ${message.author.tag}` })
                ...
                .catch(() => message.reply('❌ لا يمكنني حظر هذا العضو (صلاحياته أعلى مني).'));
            return;
        }

        // ==========================================
        // ⏳ أمر التايم أوت (!timeout) مع اللوج
        // ==========================================
        ...
        // باقي الأوامر الإدارية (مسح، سحب فويس)
