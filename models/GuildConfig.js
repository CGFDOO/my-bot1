...
const ticketButtonSchema = new mongoose.Schema({
    ...
    insideEmbedDesc: { type: String, default: 'يرجى كتابة طلبك بالتفصيل هنا...' },
    ...
    enableRating: { type: Boolean, default: true } // 🔥 خيار التقييم التلقائي
});
...
const guildConfigSchema = new mongoose.Schema({
    ...
    warnReasons: { type: [String], default: ['مخالفة القوانين', 'ألفاظ خارجة', 'سرقة زبائن', 'إزعاج الإدارة'] }, 
